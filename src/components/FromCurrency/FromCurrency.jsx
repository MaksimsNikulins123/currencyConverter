...
export const FromCurrency = ({currencies, fromCurrencyInput, popularCurrencies, setPopularCurrencies, fromCurrency, onChangeValue, onChangeFromCurrency }) => {
  ...
  <div className="block">
    <ul className="currencies">
      {popularCurrencies.map((cur) => (
        <li
          onClick={() => onChangeFromCurrency(cur)}
